...
function EntryListItem({ entry }: Props) {
  return (
    <div>
      <h3 className='text-4xl text-gray-400 font-serif mb-5'>{dateFormatter(entry.publishedAt)}</h3>
      <div className='flex'>
        ...
        <div className='flex-1 pl-10'>
          <div className='flex flex-col justify-between h-full'>
            ...
            <p className='max-w-2xl text-lg tracking-wider'>{entry.description}</p>
            <ClientSideRoute route={`/entry/${entry.slug.current}`}>
